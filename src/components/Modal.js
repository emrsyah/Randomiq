        ...
        <div className="centered bg-white p-5 rounded-md w-[540px]">
          <div className="flex justify-between mb-4 border-b-[1px] border-b-gray-300 pb-1">
            <div>
              ...
              <p className="text-sm">
                {selectedChallenge.type} - {selectedChallenge.participant}{" "}
                People
              </p>
            </div>
            <Icon
          ...
          <form onSubmit={postChallengeHandler}>
            ...
            <input
              ...
              required
              hidden
              onChange={(ev) => setSelectedImg(ev.target.files[0])}
              accept="image/*"
            />
            <div
            ...
            <button
              type="submit"
              className={`mt-8 py-2 px-4 bg-[#ffc300] hover:bg-yellow-500 rounded-md font-medium ${
                loading && "opacity-60"
              }`}
              disabled={loading}
            >
